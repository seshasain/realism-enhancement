...
if comfy_path is None:
    try:
        ...
        # Fallback to a more reliable method if __main__.__file__ is not available
        print("[ComfyUI-Manager] Could not determine ComfyUI path from __main__.__file__, using fallback.")
        # __file__ is the path to the current script (prestartup_script.py)
        # The path to ComfyUI is two directories up from the custom_nodes folder.
        # .../custom_nodes/ComfyUI-Manager/prestartup_script.py
        # -> .../custom_nodes/ComfyUI-Manager/
        # -> .../custom_nodes/
        # -> .../
        comfyui_manager_path = os.path.dirname(__file__)
        custom_nodes_path = os.path.dirname(comfyui_manager_path)
        comfy_path = os.path.dirname(custom_nodes_path)
